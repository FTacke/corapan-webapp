...
class RefreshToken(Base):
    ...
    token_id: Mapped[Optional[str]] = mapped_column("token_id", String(36), primary_key=True)
    user_id: Mapped[Optional[str]] = mapped_column(ForeignKey("users.user_id"), nullable=False)
