...
def corpus_stats():
    ...
    country count) from a static JSON file generated by the pipeline.
    
    The file location is configurable via PUBLIC_STATS_DIR app config:
    - Default: static/img/statistics/corpus_stats.json
    - If CORAPAN_RUNTIME_ROOT is set: ${CORAPAN_RUNTIME_ROOT}/data/public/statistics/corpus_stats.json
    ...
    """
    stats_dir = Path(current_app.config.get('PUBLIC_STATS_DIR', 'static/img/statistics'))
