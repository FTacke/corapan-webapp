...
def test_build_snippet_and_play_audio_route(tmp_path):
    ...
    snippet_path = build_snippet(filename, start, end, token_id='argx_demo', snippet_type='pal')
...
def test_find_split_file_and_cache_naming():
    ...
    target_ctx = build_snippet('2025-11-17_ARG_Test.mp3', 1.0, 2.1, token_id='argx_demo', snippet_type='ctx')
