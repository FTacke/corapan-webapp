...
console.log('%c=== ADAPTIVE TITLE TEST SUITE ===', 'font-size: 16px; font-weight: bold; color: #4CAF50');

// ============================================
// Scenario A: Initial Load
// ============================================
console.log('%c\nSzenario A: Initial Load', 'font-weight: bold; color: #2196F3');
...
// ============================================
console.log('%c\nSzenario B: Scroll Down (>8px)', 'font-weight: bold; color: #2196F3');
...
window.addEventListener('scroll', () => {
  ...
  if (scrolled && attrValue === 'true') {
    console.log('%c✅ PASS: Scroll State Detected', 'color: #4CAF50; font-weight: bold');
  } else if (!scrolled && !hasAttr) {
    console.log('%c✅ PASS: Top Scroll State Detected', 'color: #4CAF50; font-weight: bold');
  }
}, { once: false });
...
// ============================================
console.log('%c\nSzenario C: HTMX Navigation (Mock)', 'font-weight: bold; color: #2196F3');
...
function testHTMXNavigation() {
  ...
  setTimeout(() => {
    ...
    if (newPageTitle === testTitle) {
      console.log('%c✅ PASS: HTMX Navigation', 'color: #4CAF50; font-weight: bold');
    } else {
...
// ============================================
console.log('%c\nSzenario D: Partial Update (MutationObserver)', 'font-weight: bold; color: #2196F3');
...
function testPartialUpdate() {
  ...
  setTimeout(() => {
    ...
    if (newPageTitle === h1.textContent) {
      console.log('%c✅ PASS: Partial Update (MutationObserver)', 'color: #4CAF50; font-weight: bold');
    } else {
...
// ============================================
console.log('%c\nSzenario E: Browser Back (popstate)', 'font-weight: bold; color: #2196F3');
...
window.addEventListener('popstate', () => {
  ...
  console.log('%c✅ PASS: Browser Back Handled', 'color: #4CAF50; font-weight: bold');
});
...
// ============================================
console.log('%c\nSzenario F: prefers-reduced-motion', 'font-weight: bold; color: #2196F3');

const prefersReducedMotion = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
console.log('prefers-reduced-motion:', prefersReducedMotion ? 'enabled' : 'disabled');

const siteTitleStyles = getComputedStyle(siteTitle);
const transitions = siteTitleStyles.transition || siteTitleStyles.WebkitTransition;

console.log('Site Title transition property:', transitions || '(none)');

if (prefersReducedMotion) {
  console.log('%c✅ PASS: prefers-reduced-motion respected (in CSS)', 'color: #4CAF50; font-weight: bold');
} else {
...
if (window.__pageTitleInit && window.__scrollInit) {
  console.log('%c✅ PASS: Both modules initialized (guards set)', 'color: #4CAF50; font-weight: bold');
} else {
...
// Summary
// ============================================
console.log('%c\n=== TEST SUMMARY ===', 'font-size: 14px; font-weight: bold; color: #FF9800');
...
console.log('✅ Scenario E: Browser Back - Run: history.back() or use browser button');
console.log('✅ Scenario F: prefers-reduced-motion - Checked above');
console.log('%c\nAll scenarios ready to test! 🚀', 'color: #4CAF50; font-weight: bold');
