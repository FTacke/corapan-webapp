...
parser.add_argument("--days", type=int, default=None, help="Override retention days (default: config)")
args = parser.parse_args()

app = create_app("production")
with app.app_context():
    from src.app.auth import services
    days = args.days if args.days is not None else app.config.get("AUTH_ACCOUNT_ANONYMIZE_AFTER_DAYS", 30)
