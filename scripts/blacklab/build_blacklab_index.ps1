...
Write-Host "  Webapp Root:     $webappRoot" -ForegroundColor Gray
...
Write-Host "  1. Start server:  .\webapp\scripts\blacklab\start_blacklab_docker_v3.ps1 -Detach" -ForegroundColor Gray
