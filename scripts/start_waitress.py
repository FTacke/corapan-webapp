...
def main():
    parser = argparse.ArgumentParser(description="Start CO.RA.PAN Flask app with Waitress")
    ...
    print(f"Starting Waitress WSGI server on {args.host}:{args.port} (threads={args.threads})")
