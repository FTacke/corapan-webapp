...
| File | Purpose |
|------|---------|
| `reports/datatables-lint.json` | DataTables CSS lint results |
| `reports/cards-lint.json` | Cards/index CSS lint results |
| `reports/auth-check.json` | Auth forms validation |
